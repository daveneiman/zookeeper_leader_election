...
import edu.harvard.hul.ois.drs2.services.zookeeper.ZooKeeperService;
...
public class LeaderElectionLauncher {
	...
	public static void main(String[] args) throws IOException {
		...
		if(args.length < 2) {
			System.err.println("Usage: java -jar <jar_file_name> <zkhost:port pairs>");
			System.exit(2);
		}
		...
		final Future<?> status = service.submit(new ZooKeeperService(zkURL));
